...
private function parseTextToQuestions($text) {
    ...
    public function showAEPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/ae.php');
    }

    public function showAIDSPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/aids.php');
    }

    public function showBMEPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/bme.php');
    }

    public function showCSDPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/csd.php');
    }

    public function showCSPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/cs.php');
    }

    public function showIOTPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/iot.php');
    }

    public function showITPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/it.php');
    }

    public function showSFEPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/sfe.php');
    }

    public function showMBAPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/mba.php');
    }

    public function showMCAPage(){
        if(!isset($_SESSION['user']) || !in_array($_SESSION['user']['role'], ['student', 'admin'])){ header('Location: /login'); exit; }
        $this->view('student/mca.php');
    }
}
