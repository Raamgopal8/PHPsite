<div class="bg-white/80 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-sm max-w-2xl mx-auto">
    ...
    <form action="/admin/materials" method="POST" class="space-y-6">
        ...
        <div>
            <label for="category" class="block text-sm font-medium text-gray-700 mb-2">Category / Subject</label>
            <input type="text" id="category" name="category" required
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                   placeholder="e.g., Computer Science, Group 2, IAS">
        </div>
        ...
        <div class="flex justify-end space-x-3 pt-4">
            <a href="/admin/materials<?= isset($_GET['domain']) ? '?domain=' . urlencode($_GET['domain']) : '' ?>" class="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50">
                Cancel
            </a>
