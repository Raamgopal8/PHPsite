<?php $path = 'admin/materials/index.php'; ?>
...
<div class="bg-white/80 backdrop-blur-md rounded-2xl p-6 border border-white/20 shadow-sm">
    ...
    <?php if(empty($materials)): ?>
        <div class="text-center py-12 bg-gray-50 rounded-xl border border-dashed border-gray-300">
            ...
            <p class="mt-2 text-gray-500 font-medium">No material links found</p>
            <p class="text-sm text-gray-400 mt-1">Get started by adding your first material link</p>
        </div>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            ...
                            <?php if (!empty($material['description'])): ?>
                                <div class="text-sm text-gray-500"><?= htmlspecialchars(substr($material['description'], 0, 60)) ?>...</div>
                            <?php endif; ?>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
                                <?= htmlspecialchars($material['domain'] ?? 'GATE') ?>
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="/admin/materials/<?= $material['id'] ?>" class="text-green-600 hover:text-green-900 mr-4">View</a>
                            <a href="/admin/materials/<?= $material['id'] ?>/delete" onclick="return confirm('Are you sure you want to delete this material?')" class="text-red-600 hover:text-red-900">Delete</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
