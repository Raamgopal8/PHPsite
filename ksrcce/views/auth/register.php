                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" id="name" name="name" required class="light-input !pl-12" placeholder="">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="text" id="department" name="department" required class="light-input !pl-12" placeholder="">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative group">
                            ...
                            <input type="password" id="password" name="password" required class="light-input !pl-12 !pr-14" placeholder="">
