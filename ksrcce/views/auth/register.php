    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <a href="/" class="inline-flex items-center space-x-3">
                <img src="/assets/KSR College of Engineering.jpg" alt="KSR College of Engineering" class="h-14 w-auto object-contain">
                <div class="h-12 w-px bg-gradient-to-b from-transparent via-gray-300 to-transparent"></div>
                <img src="/assets/ccelogo.jpg" alt="CCE Department" class="h-12 w-auto object-contain">
            </a>
            ...
            <form action="/register" method="post" class="space-y-6" onsubmit="return validateEmailDomain()">
                ...
                <div class="flex items-center">
                    ...
                    <label for="terms" class="ml-2 block text-sm text-gray-700">
                        I agree to the <a href="/terms" class="text-blue-600 hover:text-blue-500 font-medium">Terms</a> and <a href="/privacy" class="text-blue-600 hover:text-blue-500 font-medium">Privacy Policy</a>
                    </label>
                </div>
