    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="exam-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">TNPSC Group 4 & VAO</h1>
                    <p class="mt-2 text-purple-100 font-medium">Clerical Level Posts Exam Preparation</p>
                </div>
            </div>
        </div>
                        ...
                        ?>
                            <div class="item-row flex items-center justify-between">
                                ...
                                <a href="<?= htmlspecialchars($syllabus['url']) ?>" target="_blank" rel="noopener noreferrer"
                                   class="ml-4 px-4 py-1.5 bg-white border border-slate-200 text-xs font-bold rounded-lg text-purple-600 hover:bg-purple-50 hover:border-purple-200 transition-all shadow-sm">
                                    View PDF
                                </a>
                            </div>
                        <?php
                        ...
                        ?>
                            <div class="item-row flex items-center justify-between">
                                ...
                                <a href="<?= htmlspecialchars($material['url']) ?>" target="_blank" rel="noopener noreferrer"
                                   class="ml-4 px-4 py-1.5 bg-purple-600 text-white text-xs font-bold rounded-lg hover:bg-purple-700 transition-all shadow-md shadow-purple-100">
                                    Download
                                </a>
                            </div>
                        <?php
                ...
                <div class="light-exam-card">
                    ...
                    <div class="space-y-3">
                        <a href="https://docs.google.com/spreadsheets/d/1BbRhnApbI4COj_2CupSA9j6_YYKSJ43deL38UX-88eA/edit?usp=sharing" 
                           class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-all group">
                ...
                <div class="light-exam-card">
                    ...
                    <div class="space-y-4">
                        <a href="https://www.tnpsc.gov.in/" target="_blank" rel="noopener noreferrer" 
                           class="flex items-center justify-between p-3 bg-purple-50 text-purple-700 rounded-xl font-bold text-xs hover:bg-purple-100 transition-colors">
