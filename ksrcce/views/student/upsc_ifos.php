<?php $path = 'student/upsc_ifos.php'; ?>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white">Indian Forest Service (IFoS) 2026</h1>
                    <p class="mt-1 text-gray-300">Conducted along with CSE Prelims for forest service officers</p>
                </div>
            </div>
        </div>
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        ?>
                             <div class="p-4 bg-blue-900/20 rounded-lg">
                                <h3 class="font-medium text-blue-300">Syllabus</h3>
                                <p class="text-sm text-gray-300 mt-1">General Studies (Prelims is same as CSE), Specific papers for Mains.</p>
                            </div>
                        <?php
                        }
                        ?>
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <a href="https://upsc.gov.in/examinations/previous-question-papers" target="_blank" class="flex items-center justify-between p-3 hover:bg-gray-700/50 rounded-lg transition-colors">
                            <span>IFoS Previous Years Papers</span>
