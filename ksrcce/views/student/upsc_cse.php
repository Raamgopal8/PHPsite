    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white">Civil Services Examination (CSE) 2026</h1>
                    <p class="mt-1 text-gray-300">For IAS, IPS, IFS, and Central Services Group A/B (Prelims: May 24, 2026; Mains: Aug 21, 2026)</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-4">
                        <?php
                        // Fetch UPSC CSE materials from database
                        try {
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <a href="https://docs.google.com/spreadsheets/d/1bimVRDuxkR4CqHBWa3CRR0nAedI1xAVgHh1LevZBAeM/edit?usp=sharing" class="flex items-center justify-between p-3 hover:bg-gray-700/50 rounded-lg transition-colors">
                            <span>UPSC CSE Previous Years</span>
