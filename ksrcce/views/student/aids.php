    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="dept-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">Artificial Intelligence & Data Science</h1>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="light-dept-card">
                    ...
                    <div class="space-y-1">
                        ...
                        try {
                            ...
                            $stmt = $db->prepare("SELECT * FROM syllabi WHERE subject LIKE ? OR subject LIKE ? OR subject LIKE ? ORDER BY created_at DESC");
                            $stmt->execute(['%AI%', '%Data Science%', '%AI&DS%']);
                ...
                <div class="light-dept-card">
                    ...
                    <div class="space-y-1">
                        ...
                        try {
                            $db = (new \App\Core\App())->db;
                            $stmt = $db->prepare("SELECT * FROM materials WHERE category LIKE ? OR category LIKE ? OR category LIKE ? ORDER BY created_at DESC");
                            $stmt->execute(['%AI%', '%Data Science%', '%AI&DS%']);
