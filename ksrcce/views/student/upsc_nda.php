    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white">NDA & NA Examination 2026</h1>
                    <p class="mt-1 text-gray-300">For 12th-pass students entering Armed Forces (Army, Navy, Air Force)</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-4">
                        ...
                        ?>
                             <div class="p-4 bg-blue-900/20 rounded-lg">
                                <h3 class="font-medium text-blue-300">Syllabus</h3>
                                <p class="text-sm text-gray-300 mt-1">Mathematics and General Ability Test.</p>
                            </div>
                        <?php
                        }
                        ?>
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-4">
                        <?php
                        // Fetch NDA materials from database
                        try {
                            $db = (new \App\Core\App())->db;
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <a href="https://upsc.gov.in/examinations/previous-question-papers" target="_blank" class="flex items-center justify-between p-3 hover:bg-gray-700/50 rounded-lg transition-colors">
                            <span>NDA Previous Years Papers</span>
