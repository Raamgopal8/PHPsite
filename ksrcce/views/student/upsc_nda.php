    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="exam-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">NDA & NA Examination 2026</h1>
                    <p class="mt-2 text-indigo-100 font-medium">For 12th-pass students entering Armed Forces (Army, Navy, Air Force)</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="space-y-3">
                        <a href="https://upsc.gov.in/examinations/previous-question-papers" target="_blank" 
                           class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50 transition-all group">
                            <span class="font-bold text-slate-700 text-sm">NDA Previous Years Papers</span>
