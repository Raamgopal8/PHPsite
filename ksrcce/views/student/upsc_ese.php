    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                <a href="/student/upsc" class="mr-4 text-blue-400 hover:text-blue-300">
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" />
                    </svg>
                </a>
                <div>
                    <h1 class="text-3xl font-bold text-white">Engineering Services (IES/ESE) 2026</h1>
                    <p class="mt-1 text-gray-300">Technical services for Engineers (Civil, Mechanical, Electrical, Electronics)</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        ?>
                            <div class="p-4 bg-blue-900/20 rounded-lg">
                                <h3 class="font-medium text-blue-300">Syllabus</h3>
                                <p class="text-sm text-gray-300 mt-1">Syllabus content will be updated soon.</p>
                            </div>
                        <?php
                            endif;
                        } catch (Exception $e) {
                        ?>
                             <div class="p-4 bg-blue-900/20 rounded-lg">
                                <h3 class="font-medium text-blue-300">Syllabus</h3>
                                <p class="text-sm text-gray-300 mt-1">Civil, Mechanical, Electrical, Electronics & Telecommunication Engineering.</p>
                            </div>
                        <?php
                        }
                        ?>
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <a href="https://upsc.gov.in/examinations/previous-question-papers" target="_blank" class="flex items-center justify-between p-3 hover:bg-gray-700/50 rounded-lg transition-colors">
                            <span>ESE Previous Years Papers</span>
            ...
            <div class="space-y-6">
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <a href="https://upsc.gov.in/" target="_blank" rel="noopener noreferrer" class="flex items-center text-blue-400 hover:text-blue-300">
