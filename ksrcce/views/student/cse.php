    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="dept-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">Computer Science & Engineering</h1>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="light-dept-card">
                    ...
                    <div class="space-y-1">
                        ...
                        ?>
                            <div class="item-row bg-indigo-50 border-indigo-100">
                                <h3 class="font-bold text-indigo-900 text-sm">Engineering Mathematics</h3>
                                <p class="text-[11px] text-indigo-600 font-medium mt-0.5">Core topics for CSE GATE</p>
                            </div>
                        <?php
                        }
                        ?>
