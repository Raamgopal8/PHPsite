    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="dept-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">Mechanical Engineering</h1>
                    <p class="mt-2 text-indigo-100 font-medium">GATE Exam Preparation Materials</p>
                </div>
            </div>
        </div>
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="light-dept-card">
                    ...
                    <div class="space-y-1">
                        ...
                        try {
                            ...
                            $stmt = $db->prepare("SELECT * FROM syllabi WHERE (subject LIKE ? OR subject LIKE ?) AND subject NOT LIKE '%Biomedical%' AND subject NOT LIKE '%BME%' ORDER BY created_at DESC");
                            $stmt->execute(['%Mechanical%', '%ME%']);
                ...
                <div class="light-dept-card">
                    ...
                    <div class="space-y-1">
                        ...
                        try {
                            $db = (new \App\Core\App())->db;
                            $stmt = $db->prepare("SELECT * FROM materials WHERE (category LIKE ? OR category LIKE ?) AND category NOT LIKE '%Biomedical%' AND category NOT LIKE '%BME%' ORDER BY created_at DESC");
                            $stmt->execute(['%Mechanical%', '%ME%']);
                    ...
                    <a href="https://docs.google.com/spreadsheets/d/19G5PYelZ0mTleHDiqo16bG8y8cLdvtW-U8doomIn8W4/edit?gid=0#gid=0" 
                       class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50 transition-all group">
                        <div class="flex items-center gap-3">
                            ...
                            <span class="font-bold text-slate-700 text-sm">GATE Question Bank</span>
                        </div>
