<?php $path = 'student/banking_rbi.php'; ?>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="exam-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">RBI Grade B</h1>
                    <p class="mt-2 text-indigo-100 font-medium">Reserve Bank of India Officers Exam</p>
                </div>
            </div>
        </div>
                    ...
                    <div class="space-y-3">
                        <a href="https://docs.google.com/spreadsheets/d/1TJ90bDyU9lNbREutEi18Er-pKDYPkdPbymL3CBJfOO0/edit?usp=sharing" 
                           class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50 transition-all group">
                            <span class="font-bold text-slate-700 text-sm">RBI Grade B Previous Years Papers</span>
                    ...
                    <div class="space-y-4">
                        <a href="https://www.rbi.org.in/" target="_blank" rel="noopener noreferrer" 
                           class="flex items-center justify-between p-3 bg-indigo-50 text-indigo-700 rounded-xl font-bold text-xs hover:bg-indigo-100 transition-colors">
                            <span>RBI Official Website</span>
