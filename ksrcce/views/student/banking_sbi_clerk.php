<?php $path = 'student/banking_sbi_clerk.php'; ?>
    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="exam-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">SBI Clerk</h1>
                    <p class="mt-2 text-indigo-100 font-medium">State Bank of India Junior Associates Exam</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="light-exam-card">
                    ...
                    <div class="space-y-1">
                        ...
                        try {
                            ...
                            $stmt->execute(['%SBI Clerk%', '%Banking%']);
                ...
                <div class="light-exam-card">
                    ...
                    <div class="space-y-3">
                        <a href="https://docs.google.com/spreadsheets/d/1TJ90bDyU9lNbREutEi18Er-pKDYPkdPbymL3CBJfOO0/edit?usp=sharing" 
                           class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50 transition-all group">
                            <span class="font-bold text-slate-700 text-sm">SBI Clerk Previous Years Papers</span>
