    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-3xl font-bold text-white">SBI Clerk</h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-4">
                        <?php
                        // Fetch SBI Clerk materials from database
                        try {
                ...
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <a href="https://docs.google.com/spreadsheets/d/1TJ90bDyU9lNbREutEi18Er-pKDYPkdPbymL3CBJfOO0/edit?usp=sharing" class="flex items-center justify-between p-3 hover:bg-gray-700/50 rounded-lg transition-colors">
                            <span>SBI Clerk Previous Years</span>
            ...
            <div class="space-y-6">
                <div class="bg-gray-800/60 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-sm">
                    ...
                    <div class="space-y-3">
                        <a href="https://www.sbi.co.in/" target="_blank" rel="noopener noreferrer" class="flex items-center text-blue-400 hover:text-blue-300">
                            <span>SBI Clerk Official</span>
