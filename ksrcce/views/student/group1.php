    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="exam-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">TNPSC Group 1</h1>
                    <p class="mt-2 text-emerald-100 font-medium">Gazetted Officers Exam Preparation</p>
                </div>
            </div>
        </div>
                        ...
                        ?>
                            <div class="item-row flex items-center justify-between">
                                ...
                                <a href="<?= htmlspecialchars($syllabus['url']) ?>" target="_blank" rel="noopener noreferrer"
                                   class="ml-4 px-4 py-1.5 bg-white border border-slate-200 text-xs font-bold rounded-lg text-emerald-600 hover:bg-emerald-50 hover:border-emerald-200 transition-all shadow-sm">
                                    View PDF
                                </a>
                            </div>
                        <?php
                ...
                <div class="light-exam-card">
                    ...
                    <div class="space-y-3">
                        <a href="https://docs.google.com/spreadsheets/d/1BbRhnApbI4COj_2CupSA9j6_YYKSJ43deL38UX-88eA/edit?usp=sharing" 
                           class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-emerald-300 hover:bg-emerald-50 transition-all group">
                ...
                <div class="light-exam-card">
                    ...
                    <div class="space-y-4">
                        <a href="https://www.tnpsc.gov.in/" target="_blank" rel="noopener noreferrer" 
                           class="flex items-center justify-between p-3 bg-emerald-50 text-emerald-700 rounded-xl font-bold text-xs hover:bg-emerald-100 transition-colors">
