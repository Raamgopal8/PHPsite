    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="exam-hero shadow-xl relative overflow-hidden">
            ...
            <div class="relative z-10 flex items-center">
                ...
                <div>
                    <h1 class="text-3xl md:text-4xl font-black" style="font-family:'Outfit',sans-serif;">Combined Geo-Scientist Exam</h1>
                    <p class="mt-2 text-indigo-100 font-medium">Entrance to Geological Survey of India & CGWB</p>
                </div>
            </div>
        </div>
                ...
                <div class="light-exam-card">
                    ...
                    <div class="space-y-1">
                        ...
                        try {
                            ...
                            $stmt->execute(['%Geo-Scientist%', '%UPSC%']);
                    ...
                    <div class="space-y-3">
                        <a href="https://upsc.gov.in/examinations/previous-question-papers" target="_blank" 
                           class="flex items-center justify-between p-4 bg-slate-50 border border-slate-200 rounded-xl hover:border-indigo-300 hover:bg-indigo-50 transition-all group">
                            <span class="font-bold text-slate-700 text-sm">Geo-Scientist Previous Years Papers</span>
